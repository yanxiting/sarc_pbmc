...
We applied WGCNA to the expression levels of IFNgamma signaling genes to identify clusters of highly correlated genes.
...
#### DEGs between cluster 5 and 6

We decided to use the kmeans clustering results when k=6. Cluster 5 and 6 were found to be the two extreme clusters. In this section, we identify DEGs between cluster 5 and 6 and conduct a functional analysis of the identified DEGs to shed light on the meaning of cluster 5 and 6.
...
data.dir<-file.path(home.dir,"scratch/GRADS/SARC_results/Results_summary_PBMC_hg38")
fpkm.filepath<-file.path(home.dir,"scratch/GRADS/SARC_results/Results_summary_PBMC_hg38/baseline/data_adjusted2","TPM_baseline_276_clean_celldiffadjusted_withannot.txt")
kmeans.clustering.filepath<-file.path(home.dir,"scratch/GRADS/SARC_results/Results_summary_PBMC_hg38/baseline/kmeans_IFNgamma/kmeans_k6_patient_clustering.txt")
...
# load in the kmeans clustering results
