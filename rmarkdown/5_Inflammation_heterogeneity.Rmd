...
* Cluster patients using hierarchical clustering.
...
```{r}
# Show the heatmaps of expression by sorting genes based on both SD and CV.
# sort the cells for cell types, disease and subjects
temp.row.data<-data.frame(GeneNames=rownames(my.data.norm),SD=my.sd,CV=my.cv,stringsAsFactors=F)
