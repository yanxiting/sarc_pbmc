...
for(i in 1:nrow(my.data.matrix)){
  temp.data<-data.frame(gexp=t(my.data.matrix[i,]),mono=cell.data[,1],eos=cell.data[,2],lym=cell.data[,3],neut=cell.data[,4])
...
output.filepath<-file.path(output.dir,"data","TPM_baseline_276_clean_celldiffadjusted_withannot.txt")
...
output.dir<-file.path(home.dir,"scratch/GRADS/SARC_results/Results_summary_PBMC_hg38/baseline/WGCNA_celladjusted")
